...
validation_root_class = os.path.join(os.getcwd(), 'experiments', 'validation', 'class_task')
validation_root_mlm = os.path.join(os.getcwd(), 'experiments', 'validation', 'mlm_task')

validation_root_class_files = os.path.join(validation_root_class,'files')
validation_root_mlm_files = os.path.join(validation_root_mlm,'files')
#--------

gm_class_dir = os.path.join(validation_root_class, 'gabriel_mask')
rgm_class_dir = os.path.join(validation_root_class, 'random_gabriel_mask')  

gm_mlm_dir = os.path.join(validation_root_mlm, 'gabriel_mask')
rgm_mlm_dir = os.path.join(validation_root_mlm, 'random_gabriel_mask')  

gm_class_img_dir = os.path.join(validation_root_class_files,'img','gabriel_mask')
rgm_class_img_dir = os.path.join(validation_root_class_files,'img','random_gabriel_mask')  

text_class_dir = os.path.join(validation_root_class_files,'txt')

gm_mlm_img_dir = os.path.join(validation_root_mlm_files,'img','gabriel_mask')
rgm_mlm_img_dir = os.path.join(validation_root_mlm_files,'img','random_gabriel_mask') 

text_mlm_dir = os.path.join(validation_root_mlm_files,'txt')
...
def main():
    ...
    sliced_train_dataset = DatasetDict(dataset["validation"][:])
